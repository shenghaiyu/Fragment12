    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mParam1){
            case "1":
                ...
                break;
            case "2":
                textViewWord.setText("blue");
                textViewMeaning.setText("蓝色");
                textViewSample.setText("my favourite colour is blue");
                break;
            case "3":
                textViewWord.setText("case");
                textViewMeaning.setText("案例");
                textViewSample.setText("I have a case to handle");
                break;
            case "4":
                textViewWord.setText("oriange");
                textViewMeaning.setText("橘色");
                textViewSample.setText("my favourite colour is oriange");
        }
        return view;
    }
